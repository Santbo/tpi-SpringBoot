...
public class ItemServiceImpl implements ItemService{
    ...
    public ItemCarrito crearItemCarrito(Carrito carrito, Producto producto, int cantidad){
        //logica de crear items de acuerdo al producto que nos envian
        Optional<ItemCarrito> itemCarrito = getItemCarritoById(carrito.getItemsCarrito(), producto.getId());
        productoService.descontarStock(producto, cantidad);
        //regla de negocio/restriccion
